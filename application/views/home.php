...
<html lang="en">
  ...
  <body>
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 text-center">
              <div class="contents">
                ...
                <?php
                $str = "https://wa.me/628813183599?text=Hallo *fauzi*, Saya tertarik dengan CV kamu.";
                ...
                <div class="header-button wow fadeInUp" data-wow-delay="1s">
                  <a href="assets/backend_fauzi" class="btn btn-common">Change Text on Admin</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="img-thumb wow fadeInLeft" data-wow-delay="0.3s">
              <img class="img-fluid" src="assets/img/about/5.jpeg" alt="">
            </div>
          </div> 
          <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-3 text-center col-padding animate-box">
					<a href="#" class="work" style="background-image: url(assets/img/gallery/as1.jpg);">
						<div class="desc">
							<h3>Project Name</h3>
				...
				<div class="col-md-3 text-center col-padding animate-box">
					<a href="#" class="work" style="background-image: url(assets/img/gallery/b.png);">
						<div class="desc">
							<h3>Project Name</h3>
							<span>Brading</span>
						</div>
				...
				<div class="col-md-3 text-center col-padding animate-box">
					<a href="#" class="work" style="background-image: url(assets/img/gallery/c.png);">
						<div class="desc">
							<h3>Project Name</h3>
							<span>Illustration</span>
						</div>
				...
				<div class="col-md-3 text-center col-padding animate-box">
					<a href="#" class="work" style="background-image: url(assets/img/gallery/f.png);">
						<div class="desc">
							<h3>Project Name</h3>
							<span>Design</span>
						</div>
				...
				<div class="col-md-3 text-center col-padding animate-box">
					<a href="#" class="work" style="background-image: url(assets/img/gallery/pkdk1.png);">
						<div class="desc">
							<h3>Project Name</h3>
							<span>Website</span>
						</div>
    ...
    <script src="assets/js/jquery-min.js'); ?cript>
    <script src="assets/js/popper.min.js'); ?cript>
    <script src="assets/js/bootstrap.min.js')</script>
    <script src="assets/js/jquery.mixitup.js'></script>
    <script src="assets/js/jquery.counterup.m); ?>"></script>
    <script src="assets/js/waypoints.min.js')</script>
    <script src="assets/js/wow.js'); ?>"></sc    <script src="assets/js/jquery.nav.js'); ?cript>
    <script src="assets/js/jquery.easing.min.?>"></script>  
